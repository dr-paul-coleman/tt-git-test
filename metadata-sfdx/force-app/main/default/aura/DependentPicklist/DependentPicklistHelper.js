({
   ...
   fetchDepValues: function(component, ListOfDependentFields) {
      ...
      else
      {
         ...
         component.set("v.subcatValue",null)
      }
   },
   firePicklistEvent: function(component, ListOfDependentFields) {
   	var catevent = component.getEvent("PicklistEvent");
   	catevent.setParams({
   		cat: component.get("v.catValue"),
   		subcat: component.get("v.subcatValue"),	
   	});
   		catevent.fire();
   },
